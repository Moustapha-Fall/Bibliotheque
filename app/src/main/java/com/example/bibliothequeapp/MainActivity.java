...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode,
        ...
        if (requestCode == REQUEST_ADD_EDIT_LIVRE && resultCode ==
                RESULT_OK && data != null) {

            String mode =
                    data.getStringExtra(AddEditActivity.EXTRA_MODE);
            Livre livre = (Livre)
                    data.getSerializableExtra(AddEditActivity.EXTRA_LIVRE);
            int position =
                    data.getIntExtra(AddEditActivity.EXTRA_POSITION, -1);
